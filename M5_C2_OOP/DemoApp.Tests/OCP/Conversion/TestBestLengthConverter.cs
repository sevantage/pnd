...
{
    public class TestBestLengthConverter : TestLengthConverterBase
    {
        [Theory]
        [MemberData("Conversions")]
        ...
        {
            CheckConvert(new BestLengthConverter(), fromUnit, toUnit, fromValue, expectedResult);
        }
    }
}
